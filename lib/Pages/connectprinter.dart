// ignore_for_file: unused_import, unnecessary_import, unused_element, avoid_print, deprecated_member_use, unnecessary_null_comparison
...
class ConnectToPrinterScreen extends StatelessWidget {
  ...
  void fetcher(int fid) async {
    ...
    var ref = FirebaseStorage.instance
        .ref()
        .child('gcodes/${availFood[fid]!.gcodePath}');
  ...
  Future<void> downloadGCodeFile() async {
    ...
    firebase_storage.Reference ref =
        storage.ref('gs://foodprinter-1aa35.appspot.com/files/gcodes');
  ...
  void getAllFiles() async {
    ...
    var response = await http
        .get(url, headers: {'X-Api-Key': 'B6FA89611CF149A3B08E4E7A6E6DDC72'});
    print('Response status: ${response.statusCode}');
    print('Response body: ${response.body}');
  }
