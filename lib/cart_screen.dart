      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Center(
              child: Text("Cart",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
            ),
                              ...
                              Row(crossAxisAlignment: CrossAxisAlignment.center,children: [
                                ...
                                Transform.scale(
                                  ...
                                  child: IconButton.outlined(
                                    ...
                                    color: defaultBlue,
                                    style: OutlinedButton.styleFrom(side: BorderSide(color: defaultBlue)),
                                  ),
                                ),
                                Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 0.0,horizontal: 4.0),
                                  child: Text(cart[id].toString().padLeft(2,'0'),style: const TextStyle(
            ...
            ElevatedButton(onPressed: (){}, child: const Padding(
              ...
              child: Text("CONNECT TO PRINTER",style: TextStyle(
